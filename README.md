...
- В документе [data-mart.md](data-mart.md) пошагово разобран процесс создания витрины данных в **PostgreSQL**. Таблица денормализована для поддержки разнообразных фильтров в дашборде, обеспечивая гибкость анализа.
