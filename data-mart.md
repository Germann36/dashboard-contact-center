...
Этот подход позволяет создать витрину данных для дашборда. В процессе использовались временные таблицы, представления и материализованные представления. В итоге сформирован структурированный набор данных, на основе которого строится интерактивная панель.
