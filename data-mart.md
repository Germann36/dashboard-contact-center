...
Сейчас логика усложняется, и одним из решений может быть создание календаря с разметкой дней: "Будние", "Выходные", "Праздники". Это упростит обработку и сделает код более понятным.
