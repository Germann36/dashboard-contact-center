...
По бизнес-правилу некорректно, когда отсчет SLA (время ответа) начинается с даты попадания заявки в систему, потому что заявка может поступить ночью или в выходные, когда менеджеров нет на работе. \
Поэтому было введено понятие «Дата регистрации заявки», то есть правио, которое переносит время заявки с нерабочего времени на начало смены менеджера.
