...
В планах перейти с чистого SQL на использование библиотек **Pandas**, **SQLAlchemy** и **Schedule** для более гибкой обработки данных. Начальные этапы разработки уже можно увидеть в [этом ноутбуке](contact-centr.ipynb).
