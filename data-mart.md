...
Этот подход позволяет создать витрину данных для дашборда. В процессе использовались временные таблицы, представления и материализованные представления для подготовки данных к анализу и визуализации. В итоге сформирован структурированный набор данных, на основе которого строится интерактивная панель.
